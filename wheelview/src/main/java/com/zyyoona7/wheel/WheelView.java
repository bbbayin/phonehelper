...
public class WheelView<T> extends View implements Runnable {
    ...
    private void initAttrsAndDefault(Context context, AttributeSet attrs) {
        ...
        mSideTextSize = typedArray.getDimension(R.styleable.WheelView_wv_sidetextSize, DEFAULT_TEXT_SIZE);
        mSideTextSize2 = typedArray.getDimension(R.styleable.WheelView_wv_sidetextSize2, DEFAULT_TEXT_SIZE);
        ...
        mSideTextColor = typedArray.getColor(R.styleable.WheelView_wv_side_normalItemTextColor, DEFAULT_NORMAL_TEXT_COLOR);
    ...
    private void drawItem(Canvas canvas, int index, int scrolledOffset) {
        ...
        if (Math.abs(item2CenterOffsetY) <= 0) {
            ...
            //缩小字体，实现折射效果
            float textSize = mPaint.getTextSize();
            mPaint.setTextSize(mSideTextSize2);
            //mIsBoldForSelectedItem==true 改变字体
            changeTypefaceIfBoldForSelectedItem();
